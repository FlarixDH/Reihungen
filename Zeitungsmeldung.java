...
{       
    ...
    public void schreibeZeitungsmeldung() {
        ...
        int anzahlSpieler   = 0;
        int anzahlSpiele    = namen.length;
        int summe           = berechneSumme(punkte);
        double durchschnitt = summe/anzahlSpiele;
        ...
        text("von "+durchschnitt+". Das ist ein Durchschnitt von XX.X pro Spiel.",2,118);
    ...
    public double berechneDurchschnitt(double[] zahl){
